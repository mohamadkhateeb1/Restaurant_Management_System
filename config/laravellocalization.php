...
return [
    ...
    'useAcceptLanguageHeader' => true,// هذا يحدد اللغة بناءً على تفضيلات المتصفح//////
    ...
    'hideDefaultLocaleInURL' => false,// إذا كانت اللغة الافتراضية هي الإنجليزية ، فسيتم إخفاؤها من عنوان URL

    // If you want to display the locales in particular order in the language selector you should write the order here.
    //CAUTION: Please consider using the appropriate locale code otherwise it will not work
    //Example: 'localesOrder' => ['es','en'],
    'localesOrder' => [],// ترتيب اللغات في محدد اللغة
    ...
    'localesMapping' => [],// تعيين رموز لغة مخصصة لعنوان URL
    ...
    'utf8suffix' => env('LARAVELLOCALIZATION_UTF8SUFFIX', '.UTF-8'),// اللاحقة المستخدمة لتعيين الإعدادات المحلية للنظام

    // URLs which should not be processed, e.g. '/nova', '/nova/*', '/nova-api/*' or specific application URLs
    // Defaults to []
    'urlsIgnored' => ['/skipped'],// عناوين URL التي يجب تجاهلها من التوطين

    'httpMethodsIgnored' => ['POST', 'PUT', 'PATCH', 'DELETE'],// طرق HTTP التي يجب تجاهلها من التوطين
];
