    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="text-white h3 fw-bold mb-1"><i class="fas fa-plus-circle text-primary me-2"></i>إضافة صنف بيع جديد</h2>
            ...
            <form action="{{ route('Pages.Items.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-4">
                    <button type="submit" class="btn btn-success btn-lg px-5 shadow-sm rounded-pill fw-bold transition-all hover-lift">
                        <i class="fas fa-save ml-2"></i> اعتماد الطبق وتفعيل المخزن
                    </button>
                    <a href="{{ route('Pages.Items.index') }}" class="btn btn-outline-secondary btn-lg px-4 rounded-pill text-white">إلغاء</a>
                </div>
            </form>
        </div>
    </div>
...
<style>
    .hover-lift:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(40, 167, 69, 0.3) !important; }
