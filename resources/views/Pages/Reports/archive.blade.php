...
@section('content')
    <div class="container py-5" dir="rtl">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('Pages.reports.index') }}" class="btn btn-outline-light rounded-pill px-4">العودة للتقارير
                الحية</a>
        </div>
                    ...
                    <tbody>
                        @forelse($archivedReports as $report)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('Pages.reports.destroy', $report->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="py-5 text-muted">لا يوجد سجلات مؤرشفة حالياً</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
