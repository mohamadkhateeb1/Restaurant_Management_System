            ...
            <div class="col-md-8">
                <div class="mb-4">
                    <a href="{{ route('Pages.categories.index') }}"
                        class="btn btn-soft-primary rounded-pill px-4 transition-all">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('Pages.categories.update', $category->id) }}" method="POST"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('Pages.categories.index') }}"
                                    class="text-muted text-decoration-none transition-all hover-white">
                                    <i class="fas fa-times me-1"></i> إلغاء التعديل
                                </a>
                                <button type="submit"
                                    class="btn btn-warning rounded-pill px-5 fw-bold text-dark shadow-sm transition-all hover-scale">
