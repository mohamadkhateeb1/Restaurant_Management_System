<div class="row g-4 text-white">
    ...
    {{-- القسم الأول: المعلومات الشخصية والأمان --}}
    <div class="col-md-6">
        <div class="p-4 rounded-3 h-100" style="background-color: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.05);">
            ...
            <div class="mb-3">
                <x-form.input label="البريد الإلكتروني" type="email" name="email" :value="$employee->email" placeholder="email@example.com"  />
            </div>
            ...
            <div class="mb-0">
                <x-form.input label="رقم الهاتف" type="tel" name="phone" :value="$employee->phone" placeholder="09xxxxxxxx"  />
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="p-4 rounded-3 h-100" style="background-color: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.05);">
            ...
            <div class="mb-3">
                <x-form.input label="الراتب الشهري" name="salary" type="number" step="0.01" :value="$employee->salary" class="text-end" placeholder="0.00" />
            </div>
                        ...
                        @foreach ($roles as $role)
                            <div class="col-6">
                                <div class="form-check custom-card-check">
                                    ...
                                    <label class="form-check-label text-light-50 small" for="role_{{ $role->id }}" style="cursor: pointer;">
                                        {{ $role->name }}
                                    </label>
                                </div>
                            </div>
    ...
    <div class="col-12 mt-2">
        <div class="p-4 rounded-3" style="background-color: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.05);">
            ...
            <textarea class="form-control text-white border-secondary @error('notes') is-invalid @enderror"
                id="notes" name="notes" rows="3" 
                style="background-color: #1a1d20; border: 1px solid #343a40; resize: none;"
...
<style>
    /* تحسين شكل الـ Scrollbar لصندوق الأدوار */
    .shadow-inner::-webkit-scrollbar { width: 5px; }
    .shadow-inner::-webkit-scrollbar-track { background: #1a1d20; }
    .shadow-inner::-webkit-scrollbar-thumb { background: #343a40; border-radius: 10px; }

    /* تحسينات الـ Checkbox */
