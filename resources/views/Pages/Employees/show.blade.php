    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 text-light">
                <i class="fas fa-id-badge text-info me-2"></i> ملف الموظف: <span class="text-info">{{ $employee->name }}</span>
            </h2>
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('Pages.employee.edit', $employee->id) }}" class="btn btn-warning btn-sm px-3 shadow-sm text-dark fw-bold">
        ...
        <div class="row g-4">
            {{-- العمود الجانبي: البيانات الشخصية والأدوار --}}
            <div class="col-xl-4 col-lg-5">
                <div class="card bg-dark shadow-lg border-0 h-100 overflow-hidden" style="border-radius: 15px;">
                    <div class="card-header bg-info py-3 text-center">
                        <div class="rounded-circle bg-white d-inline-flex align-items-center justify-content-center mb-2 shadow-sm" style="width: 80px; height: 80px;">
                    ...
                    <div class="card-body p-4 text-white">
                        <h6 class="text-info border-bottom border-secondary pb-2 mb-3 small text-uppercase fw-bold">بيانات الاتصال</h6>
                        ...
                        <div class="mb-4 d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @if ($employee->status == 'active')
                                    <span class="badge bg-success-soft text-success border border-success px-3 py-1 mt-1">نشط</span>
                                @else
                                    <span class="badge bg-danger-soft text-danger border border-danger px-3 py-1 mt-1">غير نشط</span>
                                @endif
                            </div>
                        </div>

                        {{-- قسم الأدوار الممنوحة (نظام Morphs) --}}
                        <h6 class="text-info border-bottom border-secondary pb-2 mb-3 small text-uppercase fw-bold">الأدوار والصلاحيات</h6>
                        <div class="d-flex flex-wrap gap-2">
                            @forelse($employee->roles as $role)
                                <span class="badge bg-primary-soft text-primary border border-primary px-3 py-2 rounded-pill">
            ...
            {{-- العمود الرئيسي: البطاقات الإحصائية والملاحظات --}}
            <div class="col-xl-8 col-lg-7">
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="card bg-dark border-0 shadow-sm p-3 h-100" style="border-right: 4px solid #0d6efd !important;">
                    ...
                    <div class="col-sm-6">
                        <div class="card bg-dark border-0 shadow-sm p-3 h-100" style="border-right: 4px solid #198754 !important;">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="mb-0 text-success fw-bold">{{ number_format($employee->salary, 2) }} <small>SAR</small></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card bg-dark border-0 shadow-sm p-3 h-100" style="border-right: 4px solid #0dcaf0 !important;">
                            <div class="d-flex align-items-center">
                    ...
                    <div class="col-sm-6">
                        <div class="card bg-dark border-0 shadow-sm p-3 h-100" style="border-right: 4px solid #6c757d !important;">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="mb-0 text-white fw-bold">{{ now()->diffInDays($employee->hire_date) }} يوم</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-2">
                        <div class="card bg-dark border-0 shadow-lg p-4" style="border-radius: 15px;">
                            ...
                            @if($employee->notes)
                                <p class="text-white-50 lh-lg bg-secondary bg-opacity-10 p-3 rounded border-start border-info border-3">
                                    {{ $employee->notes }}
                                </p>
                            @else
